...
When('I publish the post', async function () {
    ...
    let secondPublishButton = await this.driver.$(".gh-btn.gh-btn-black.gh-btn-icon.ember-view");
    return await secondPublishButton.click(); 
});
...
When('I select schedule post', async function () {
    ...
    let scheduleButton = await this.driver.$(".gh-publishmenu-footer > .gh-publishmenu-button");
    await scheduleButton.click();
    let confirmScheduleButton = await this.driver.$("button.gh-btn.gh-btn-black.gh-btn-icon.ember-view");
    return await confirmScheduleButton.click();
...
When('I create new tag with {kraken-string}', async function (name) {
    ...
    let saveButton = await this.driver.$("button.gh-btn.gh-btn-primary.gh-btn-icon.ember-view");
    return await saveButton.click();
});

When('I select tag with name {kraken-string}', async function (name) {
    let menuButton = await this.driver.$("button.settings-menu-toggle.gh-btn.gh-btn-editor.gh-btn-icon.icon-only.gh-btn-action-icon");
...
When('I close settings menu', async function () {
	let elementCloseSettings = await this.driver.$("button.settings-menu-toggle.gh-btn.gh-btn-editor.gh-btn-icon.icon-only.gh-btn-action-icon");
