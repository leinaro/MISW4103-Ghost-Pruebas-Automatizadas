...
|3. Editar Post|||
|cambiar titulo y contenido de un post|- Iniciar sesión, navegar a un post, editar el titulo y el contenido del Post, publicar post, navegar al post publicado, confirmar que los cambios se realizaron.| x |
