...
| crear post en draft |- Iniciar sesión, hacer click en el boton new post de la barra lateral, agregar titulo, agregar contenido lorem ipsum, sin hacer click en publicar navegar (http://localhost:3001/ghost/#/posts?type=draft), y validar que se creo el borrador. |Done|
...
|4. Agregar Usuario|||
|agregar staff|- Iniciar sesión, ir a la pestaña staff, click invite staff agregar un correo y por último dar click en invitar, navegar a staff y verificar que se haya agregado correctamente. | Done |
...
| agregar staff sin correo|- Iniciar sesión, ir a la pestaña miembros, click invitar staff, completar los campos sin correo , click en invitar, deberá mostrar el error Email invalido| Done|
...
|5. Modificar usuario |||
|cambiar nombre |- iniciar sesión, navegar al detalle de un miembro, modificar nombre del usuario o miembro, clic en guardar y verificar que se los cambios se encuentren | Done |
